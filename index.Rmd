...
<i class="fas fa-download"></i> Download this resume in [PDF](https://github.com/piraburu/cv_pim/blob/ing/iraburu_cv.pdf)
or view online in [html](https://htmlpreview.github.io/?https://github.com/piraburu/cv_pim/blob/ing/index.html)
...
<i class="fas fa-home"></i> Dalsteindreef 3312
...
```{r}
print_text_block(text_blocks, 'intro2')
```
